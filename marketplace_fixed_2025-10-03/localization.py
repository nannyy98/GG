...
Вот что я умею:
• 🛍 Каталог — смотрите товары по категориям
• 🛒 Корзина — добавляйте и оформляйте заказы
• 📋 Мои заказы — статус и история заказов
• 👤 Профиль — данные и язык
• 🔍 Поиск — найдите товар по названию

Если что-то не работает — просто напишите нам здесь, и мы поможем.
'''
            },
...
• 🛍 Katalog — tovarlarni ko‘rish
• 🛒 Savat — qo‘shish va buyurtma berish
• 📋 Buyurtmalarim — buyurtmalar holati
• 👤 Profil — ma’lumotlar va til
• 🔍 Qidiruv — nomi bo‘yicha topish

Agar nimadir ishlamasa — shu yerda yozing, yordam beramiz.
'''
            }
        }
